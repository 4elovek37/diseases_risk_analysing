...
from analyzer.models import Country, BedStats
import os
import wget
...
class Command(BaseCommand):
    help = 'Initiates updating of bed stats table'

    def __init__(self):
        BaseCommand.__init__(self)
        self.url = 'http://api.worldbank.org/v2/en/indicator/SH.MED.BEDS.ZS?downloadformat=xml'
        self.zip_path = './analyzer/management/commands/update_bed_stats/dataset.zip'
    ...
    def handle(self, *args, **options):
        ...
        self.clear_temp_data()
        return self.style.SUCCESS('update_bed_stats finished OK')

    @staticmethod
    def process_xml(xml):
        stats_from_xml = BedStatsFromXml()
    ...
    def update_db(stats):
        ...
        return 'update_bed_stats: inserted = %i, updated = %i' % (inserted, updated)
